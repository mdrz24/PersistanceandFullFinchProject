...
class Program
{
    ...
    static void DisplayMenuScreen()
    {
        ...
        do
        {
            DisplayScreenHeader1("Main Menu");
            ...
            Console.WriteLine("\tg) Persistence");
    ...
    static void DisplayScreenHeader1(string headerText)
    {
        Console.Clear();
        Console.WriteLine();
        Console.WriteLine("\t\t" + headerText);
    ...
    static void DisplayContinuePrompt1()
    {
        Console.WriteLine();
        Console.WriteLine("\t\tPress any key to continue.");
        Console.ReadKey();
    ...
    static void ThemeConfig()
    {
        ...
        do
        {
            ...
            {
                Console.WriteLine($"{foregroundColorString} is not a valid color, (Try starting the color with a capital letter).");
            }
